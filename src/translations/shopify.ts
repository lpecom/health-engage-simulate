...
export const shopifyTranslations: Record<string, TranslationMap> = {
  ...
  de: {
    ...
    'shopifyIntegrationDescription': 'Verbinden Sie Ihren Shopify-Shop, um Bestellungen zu synchronisieren',
    'connecting': 'Verbinden...',
    'connect': 'Verbinden',
    'shopifyConnected': 'Mit Shopify verbunden',
    'shopifySettings': 'Shopify-Einstellungen',
    'shopifyHelp1': 'Shopify-Anmeldedaten werden sicher als Supabase-Geheimnisse gespeichert.',
    ...
    'storeNotFound': 'Shop nicht gefunden: Der Name des Shopify-Shops könnte falsch sein',
    'checkCredentials': 'Überprüfen Sie Ihre Anmeldedaten in den Supabase-Geheimnissen',
