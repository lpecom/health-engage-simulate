...
export const shopifyTranslations: Record<string, TranslationMap> = {
  es: {
    ...
    'shopifyAccessToken': 'Token de acceso API Admin',
    'shopifyAccessTokenHelp': 'Token de acceso de la API de Shopify',
    'shopifyApiKey': 'Clave de API',
    'shopifyApiKeyHelp': 'Clave de API para autenticación',
    'shopifyApiSecret': 'Clave secreta de API',
    'shopifyApiSecretHelp': 'Clave secreta de API para autenticación',
  ...
  pt: {
    ...
    'shopifyAccessToken': 'Token de acesso API Admin',
    'shopifyAccessTokenHelp': 'Token de acesso da API do Shopify',
    'shopifyApiKey': 'Chave de API',
    'shopifyApiKeyHelp': 'Chave de API para autenticação',
    'shopifyApiSecret': 'Chave secreta da API',
    'shopifyApiSecretHelp': 'Chave secreta da API para autenticação',
    'connecting': 'Conectando...',
    'connect': 'Conectar',
  ...
  it: {
    ...
    'shopifyAccessToken': 'Token di accesso API Admin',
    'shopifyAccessTokenHelp': 'Token di accesso API Shopify',
    'shopifyApiKey': 'Chiave API',
    'shopifyApiKeyHelp': 'Chiave API per autenticazione',
    'shopifyApiSecret': 'Segreto API',
    'shopifyApiSecretHelp': 'Segreto API per autenticazione',
