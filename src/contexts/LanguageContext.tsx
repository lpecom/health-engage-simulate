...
const translations = {
  es: {
    ...
    enableBluetooth: "Habilita Bluetooth en tu teléfono",
    ...
    prediabeticFasting: "Prediabetes (ayuno)",
    diabeticFasting: "Diabetes (ayuno)",
    completed: "Completado",
    markAsRead: "Marcar como leído",
    keyGlucoseData: "Datos clave sobre la glucosa",
    ...
    pain: "Dolor",
    noPainAtAll: "Sin dolor",
    painfulPricks: "Pinchazos dolorosos",
    speed: "Velocidad",
    resultsInSeconds: "Resultados en segundos",
    severalMinutes: "Varios minutos",
    consumables: "Consumibles",
    noConsumables: "No requiere",
    expensiveStrips: "Tiras reactivas costosas",
    clinicalStudyTitle: "Estudio clínico: Precisión de la medición no invasiva",
    journalReference: "Journal of Medical Technology, 2023",
    studyResults: "En un estudio con 157 participantes, la tecnología de GlucoVista mostró una precisión del 96.8% comparado con métodos de análisis de sangre de laboratorio.",
  ...
  pt: {
    ...
    turnOnYourDevice: "Ligue seu dispositivo",
    enableBluetooth: "Ative o Bluetooth no seu telefone",
    enterSerialAndConnect: "Digite o número de série e conecte",
    connectDevice: "Conectar dispositivo",
    deviceOnTheWay: "Seu dispositivo está a caminho",
    yourDeviceIsBeingShipped: "Seu dispositivo está sendo enviado e chegará em breve",
    ordered: "Pedido",
    shipping: "Enviando",
    delivered: "Entregue",
    estimatedDelivery: "Entrega estimada",
    ...
    learnAboutGlucoVista: "Aprenda sobre o GlucoVista",
    ...
    prediabeticFasting: "Pré-diabetes (jejum)",
    diabeticFasting: "Diabetes (jejum)",
    completed: "Concluído",
    markAsRead: "Marcar como lido",
    keyGlucoseData: "Dados fundamentais sobre glicose",
    ...
    noConsumables: "Não requer",
    expensiveStrips: "Tiras reativas caras",
    clinicalStudyTitle: "Estudio clínico: Precisão da medição não invasiva",
    journalReference: "Revista de Tecnologia Médica, 2023",
    studyResults: "Em um estudo com 157 participantes, a tecnologia do GlucoVista mostrou uma precisão de 96.8% em comparação com métodos de análise de sangre de laboratorio.",
    moreCertificationInfo: "Mais informações sobre certificações",
    backToPlan: "Voltar ao plano",
    topicCompleted: "Tema concluído!",
  }
};
